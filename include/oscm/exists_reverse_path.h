#ifndef ONESIDEDCROSSINGNUMBER_OSCM_EXISTS_REVERSE_PATH_H
#define ONESIDEDCROSSINGNUMBER_OSCM_EXISTS_REVERSE_PATH_H
...
#endif  // ONESIDEDCROSSINGNUMBER_OSCM_EXISTS_REVERSE_PATH_H
