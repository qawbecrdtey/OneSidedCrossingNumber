#ifndef ONESIDEDCROSSINGNUMBER_OSCM_MAXIMUM_DEGREE_PIVOT_H
#define ONESIDEDCROSSINGNUMBER_OSCM_MAXIMUM_DEGREE_PIVOT_H
...
#endif  // ONESIDEDCROSSINGNUMBER_OSCM_MAXIMUM_DEGREE_PIVOT_H
